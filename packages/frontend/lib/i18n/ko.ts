export const ko = {
  ...
  dom: {
    ...
    heading: [
      ...
      { id: '건너뛰기', title: '제목 건너뛰기 금지', desc: '시각적으로 강조하고 싶다면 CSS font-size를 조절하라. 제목 레벨을 건너뛰지 말 것.' }
    ],
    nesting: [
      {
        id: '깊이',
    ...
    focus: [
      {
        id: 'DOM순서',
        title: 'DOM 순서 = 포커스 순서',
        desc: 'Tab 키 포커스는 DOM 순서를 따른다. CSS로 시각 순서를 바꿔도 포커스 순서는 DOM 기준이다.'
      },
      {
        id: 'tabindex',
        title: 'tabindex 남용 금지',
        desc: 'tabindex="0"은 포커스 허용, tabindex="-1"은 프로그래매틱 포커스용. 양수 tabindex는 거의 쓰지 말 것.'
      },
      {
        id: '포커스트랩',
