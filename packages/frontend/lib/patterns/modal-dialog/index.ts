    ...
    baseui: {
      ...
      additionalChecks: [
        ...
        },
        {
          ...
          description: 'Base UI는 Dialog와 AlertDialog를 별도로 제공합니다. 사용자 확인이 필요한 경우 @base-ui/react/alert-dialog를 사용하세요.',
          level: 'should'
        }
      ],
      codeSample: {
      ...
      notes: [
        ...
        'AlertDialog(@base-ui/react/alert-dialog)는 사용자 확인이 필요한 위험한 액션에 사용하세요.'
      ]
    }
  }
}
