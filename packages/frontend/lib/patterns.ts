...
<ConfigProvider locale={koKR}>
  ...
  },
  {
    slug: 'switch',
    name: 'Switch',
    description: 'on/off 이진 입력을 위한 스위치 컴포넌트',
    ...
    baseline: {
      checklist: {
        must: [
          {
            id: 'switch-m1',
            title: 'role="switch" 사용',
            description: '스위치 컴포넌트에 role="switch"를 적용해야 합니다.',
            level: 'must'
          },
          {
            id: 'switch-m2',
            title: 'aria-checked로 상태 전달',
            description: '스위치가 켜진 상태일 때 aria-checked="true", 꺼진 상태일 때 aria-checked="false"를 설정해야 합니다.',
            level: 'must'
          },
          {
            id: 'switch-m3',
            title: '접근 가능한 레이블 제공',
            description:
              '스위치에 aria-label, aria-labelledby, 또는 내부 텍스트로 레이블을 제공해야 합니다. 레이블은 상태가 바뀌어도 변경되지 않아야 합니다.',
            level: 'must'
          },
          {
            id: 'switch-m4',
            title: 'Space 키로 상태 전환',
            description: '포커스가 스위치에 있을 때 Space 키로 상태를 전환할 수 있어야 합니다.',
            level: 'must'
          }
        ],
        should: [
          {
            id: 'switch-s1',
            title: '시각적 상태와 ARIA 상태 동기화',
            description: '시각적으로 보이는 on/off 표시와 aria-checked 값이 항상 일치해야 합니다.',
            level: 'should'
          },
          {
            id: 'switch-s2',
            title: '그룹 내 스위치에 fieldset/legend 제공',
            description: '여러 스위치가 그룹을 이룰 때 fieldset과 legend로 그룹 레이블을 제공하세요.',
            level: 'should'
          }
        ],
        avoid: [
          {
            id: 'switch-a1',
            title: '레이블에 상태 텍스트 포함',
            description: '레이블에 상태를 텍스트로 포함하면 aria-checked와 충돌합니다. 레이블은 고정되어야 합니다.',
            level: 'avoid'
          },
          {
            id: 'switch-a2',
            title: 'div/span으로만 구현',
            description: '키보드 접근성 없이 div나 span만으로 스위치를 만들지 마세요.',
            level: 'avoid'
          }
        ]
      },
  ...
  return (
    <div>
      <label htmlFor="notif-switch">알림</label>
      <button
        id="notif-switch"
        role="switch"
        aria-checked={isOn}
        onClick={() => setIsOn(!isOn)}
        style={{ background: isOn ? '#1976d2' : '#ccc', border: 'none', borderRadius: '12px', padding: '4px 12px', cursor: 'pointer', color: 'white' }}
      >
    ...
    designSystems: {
      material: {
        ...
        additionalChecks: [
          {
            id: 'switch-mui-1',
            title: 'inputProps로 aria-label 전달',
            description: 'MUI Switch는 내부 input에 aria-label을 전달하려면 inputProps={{ "aria-label": "..." }}를 사용하세요.',
            level: 'must'
          }
        ],
        codeSample: {
...
function SwitchDemo() {
  ...
  return (
    ...
    />
        ...
        notes: [
          'FormControlLabel과 함께 사용하면 label이 자동으로 input과 연결됩니다.',
          'inputProps={{ "aria-label" }}은 FormControlLabel의 label이 없을 때 사용하세요.',
          'MUI Switch는 내부적으로 input[type=checkbox]를 사용합니다.'
        ]
      },
      radix: {
        ...
        additionalChecks: [
          {
            id: 'switch-radix-1',
            title: 'id와 label 연결',
            description: 'Radix Switch.Root에 id를 부여하고 htmlFor로 label과 연결하세요.',
            level: 'must'
          }
        ],
        codeSample: {
          language: 'tsx',
          label: 'Radix UI Switch',
          code: `import * as Switch from '@radix-ui/react-switch';
...
function SwitchDemo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      <Switch.Root id="airplane-mode" defaultChecked={false}>
        <Switch.Thumb />
      </Switch.Root>
    </div>
  );
        ...
        notes: [
          'Radix Switch.Root은 role="switch"와 aria-checked를 자동으로 처리합니다.',
          'label을 Switch.Root와 연결하면 접근성이 자동으로 완성됩니다.',
          '시각적 스타일은 CSS로 직접 구현해야 합니다.'
        ]
      },
      antd: {
        id: 'antd',
        ...
        additionalChecks: [
          {
            id: 'switch-antd-1',
            title: 'aria-label 직접 전달',
            description: 'Ant Design Switch에 aria-label prop을 직접 전달하세요.',
            level: 'must'
          }
        ],
        codeSample: {
          language: 'tsx',
          label: 'Ant Design Switch',
          code: `import Switch from 'antd/es/switch';
...
function SwitchDemo() {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      />
        ...
        notes: [
          'Ant Design Switch는 내부적으로 button 역할을 사용합니다.',
          'checkedChildren/unCheckedChildren으로 ON/OFF 레이블을 설정할 수 있습니다.',
          'aria-label은 별도 label 요소가 없을 때 반드시 추가하세요.'
        ]
      }
    }
  },
  {
    slug: 'slider',
    name: 'Slider',
    description: '범위 내에서 값을 선택하는 슬라이더 컴포넌트',
    wcagCriteria: ['2.1.1 Keyboard', '4.1.2 Name, Role, Value'],
    tags: ['form', 'interactive'],
    baseline: {
      checklist: {
        must: [
          {
            id: 'slider-m1',
            title: 'role="slider"와 값 속성',
            description: '슬라이더 thumb 요소에 role="slider"와 aria-valuenow, aria-valuemin, aria-valuemax를 설정해야 합니다.',
            level: 'must'
          },
          {
            id: 'slider-m2',
            title: '접근 가능한 레이블 제공',
            description: '슬라이더에 aria-label 또는 aria-labelledby로 레이블을 제공해야 합니다.',
            level: 'must'
          },
          {
            id: 'slider-m3',
            title: '키보드로 값 조절',
            description: 'Arrow 키로 1단계씩, Home/End로 최솟값/최댓값, Page Up/Down으로 큰 단계로 이동할 수 있어야 합니다.',
            level: 'must'
          },
          {
            id: 'slider-m4',
            title: '단위가 있는 값에 aria-valuetext 사용',
            description: '숫자만으로 의미 전달이 부족한 경우 aria-valuetext로 의미 있는 텍스트를 제공해야 합니다.',
            level: 'must'
          }
        ],
        should: [
          {
            id: 'slider-s1',
            title: '세로 방향에 aria-orientation 명시',
            description: '세로 슬라이더에는 aria-orientation="vertical"을 추가하세요.',
            level: 'should'
          },
          {
            id: 'slider-s2',
            title: '현재 값의 시각적 표시',
            description: '현재 선택된 값을 시각적으로도 보여주세요.',
            level: 'should'
          }
        ],
        avoid: [
          {
            id: 'slider-a1',
            title: '마우스 전용 구현',
            description: '드래그로만 값을 변경할 수 있는 슬라이더는 키보드 사용자가 접근할 수 없습니다.',
            level: 'avoid'
          },
          {
            id: 'slider-a2',
            title: 'aria-valuetext 없이 의미 없는 숫자만 제공',
            description: '만족도, 등급 등 숫자 외 의미가 있을 때 aria-valuetext로 설명을 추가하세요.',
            level: 'avoid'
          }
        ]
      },
  ...
  const handleKeyDown = (e) => {
    ...
    if (e.key === 'PageUp') setValue(v => Math.min(100, v + 10));
    if (e.key === 'PageDown') setValue(v => Math.max(0, v - 10));
  };

  return (
    <div>
      <label id="volume-label">볼륨: {value}%</label>
      <div
        role="slider"
        aria-valuenow={value}
        aria-valuemin={0}
        ...
        aria-valuetext={value + '퍼센트'}
        tabIndex={0}
        onKeyDown={handleKeyDown}
        style={{ width: '200px', height: '8px', background: '#ddd', position: 'relative', cursor: 'pointer', borderRadius: '4px' }}
      >
        <div style={{ position: 'absolute', left: value + '%', top: '50%', transform: 'translate(-50%, -50%)', width: '20px', height: '20px', background: '#1976d2', borderRadius: '50%' }} />
      </div>
    </div>
  );
}`
    ...
    designSystems: {
      material: {
        ...
        additionalChecks: [
          {
            id: 'slider-mui-1',
            title: 'getAriaValueText로 valuetext 제공',
            description: 'MUI Slider의 getAriaValueText prop으로 aria-valuetext를 커스터마이징하세요.',
            level: 'should'
          }
        ],
        codeSample: {
...
function SliderDemo() {
  ...
  return (
    <div>
      <label id="volume-label">볼륨</label>
      <Slider
        value={value}
        onChange={(_, v) => setValue(v as number)}
        aria-labelledby="volume-label"
        getAriaValueText={(v) => v + '퍼센트'}
      ...
      />
        ...
        notes: [
          'MUI Slider는 role="slider"와 키보드 인터랙션을 자동으로 처리합니다.',
          'getAriaValueText로 스크린리더에 의미 있는 값 텍스트를 제공하세요.',
          'valueLabelDisplay="auto"로 현재 값을 시각적으로 표시하세요.'
        ]
      },
      radix: {
        id: 'radix',
        ...
        additionalChecks: [
          {
            id: 'slider-radix-1',
            title: 'aria-label 또는 aria-labelledby 연결',
            description: 'Radix Slider.Root에 aria-label을 설정하거나 외부 레이블과 aria-labelledby로 연결하세요.',
            level: 'must'
          }
        ],
        codeSample: {
          language: 'tsx',
          label: 'Radix UI Slider',
          code: `import * as Slider from '@radix-ui/react-slider';
  ...
  return (
    <div>
      ...
      >
        ...
        notes: [
          'Radix Slider는 키보드 인터랙션과 ARIA 속성을 자동으로 관리합니다.',
          'Slider.Thumb에 aria-label을 추가하면 thumb 자체에도 접근 가능한 이름이 생깁니다.',
          '범위 슬라이더(range)는 두 개의 Thumb를 사용하세요.'
        ]
      },
      antd: {
        id: 'antd',
        ...
        additionalChecks: [
          {
            id: 'slider-antd-1',
            title: 'tooltip.formatter로 valuetext 제공',
            description: 'Ant Design Slider의 tooltip.formatter로 스크린리더에 의미 있는 값 텍스트를 제공하세요.',
            level: 'should'
          }
        ],
        codeSample: {
          language: 'tsx',
          label: 'Ant Design Slider',
          code: `import Slider from 'antd/es/slider';

function SliderDemo() {
  const [value, setValue] = useState(50);
  return (
    <div>
      <label id="vol-label">볼륨: {value}%</label>
      <Slider
        value={value}
        onChange={setValue}
        aria-labelledby="vol-label"
        tooltip={{ formatter: (v) => v + '퍼센트' }}
        min={0}
        max={100}
      />
    </div>
        ...
        notes: [
          'Ant Design Slider는 role="slider"와 키보드 탐색을 자동으로 처리합니다.',
          'tooltip.formatter로 스크린리더용 값 텍스트를 커스터마이징할 수 있습니다.',
          '범위 슬라이더는 range prop을 사용하세요.'
        ]
      }
    }
  },
  {
    slug: 'table',
    name: 'Table',
    description: '접근 가능한 헤더와 레이블을 갖춘 데이터 테이블',
    wcagCriteria: ['1.3.1 Info and Relationships', '4.1.2 Name, Role, Value'],
        ...
        must: [
          {
            id: 'table-m1',
            title: '테이블에 레이블 제공',
            description: '테이블에 aria-label 또는 aria-labelledby로 레이블을 제공해야 합니다.',
            level: 'must'
          },
          {
            id: 'table-m2',
        ...
        should: [
          {
            ...
            description: 'table 요소 바로 아래 caption을 추가해 테이블 목적을 설명하세요.',
            level: 'should'
          },
          {
            id: 'table-s2',
            title: '정렬 가능한 열에 aria-sort',
            description: '정렬 기능이 있는 열 헤더에 aria-sort="ascending" 또는 aria-sort="descending"을 설정하세요.',
            level: 'should'
          }
        ],
        avoid: [
          {
            ...
            description: '레이아웃을 위해 table을 사용하지 마세요. 레이아웃 테이블이라면 role="presentation"을 추가하세요.',
            level: 'avoid'
          },
          {
            id: 'table-a2',
            title: 'th 없이 td만 사용',
            description: '모든 셀을 td로만 만들면 스크린리더가 행/열 관계를 파악할 수 없습니다.',
            level: 'avoid'
          }
        ]
      },
  ...
  return (
    <table aria-label="직원 목록">
      ...
      <thead>
        <tr>
          <th scope="col">
            <button onClick={handleSort} aria-sort={sortDir}>
    ...
    designSystems: {
      material: {
        ...
        additionalChecks: [
          {
            id: 'table-mui-1',
            title: 'TableSortLabel로 정렬 접근성',
            description: 'MUI TableSortLabel은 aria-sort를 자동으로 관리합니다. 정렬 가능한 열에 사용하세요.',
            level: 'should'
          }
        ],
        codeSample: {
  ...
  return (
    <Table aria-label="직원 목록">
      ...
      <TableBody>
        ...
        notes: [
          'MUI Table은 HTML table 요소를 기반으로 시맨틱 구조를 유지합니다.',
          'TableSortLabel이 aria-sort를 자동으로 처리하므로 정렬 기능에 활용하세요.',
          'aria-label은 Table 컴포넌트에 직접 전달하세요.'
        ]
      },
      radix: {
        id: 'radix',
  ...
  return (
    <table aria-label="직원 목록">
      ...
      <tbody>
        ...
        notes: [
          'Radix UI는 Table 컴포넌트를 제공하지 않습니다.',
          '네이티브 HTML table 요소를 사용해 시맨틱 구조를 유지하세요.',
          'TanStack Table 같은 헤드리스 라이브러리와 조합해 사용할 수 있습니다.'
        ]
      },
      antd: {
        id: 'antd',
        ...
        additionalChecks: [
          {
            id: 'table-antd-1',
            title: 'columns에 sorter와 sortOrder 설정',
            description: 'Ant Design Table에서 정렬 기능을 사용할 때 sortDirections로 aria-sort가 올바르게 설정되는지 확인하세요.',
            level: 'should'
          }
        ],
        codeSample: {
          ...
          code: `import AntTable from 'antd/es/table';
...
const data = [
  { key: '1', name: '홍길동', dept: '개발팀' },
  { key: '2', name: '김철수', dept: '디자인팀' },
];

function TableDemo() {
  return <AntTable columns={columns} dataSource={data} aria-label="직원 목록" />;
}`
        },
        notes: [
          'Ant Design Table은 자체적인 접근성 지원을 갖추고 있습니다.',
          'aria-label prop을 Table에 직접 전달하면 테이블에 레이블이 적용됩니다.',
          '정렬 기능은 columns의 sorter 속성으로 처리하면 aria-sort가 자동 설정됩니다.'
        ]
      }
    }
  },
    ...
    baseline: {
      checklist: {
        must: [
          {
            id: 'menu-button-m1',
            title: '버튼에 aria-haspopup="menu"',
            description: '메뉴를 여는 버튼에 aria-haspopup="menu"를 설정해야 합니다.',
            level: 'must'
          },
          {
            id: 'menu-button-m2',
            title: 'aria-expanded로 열림 상태 표시',
            description: '메뉴가 열려 있을 때 버튼에 aria-expanded="true", 닫혔을 때 aria-expanded="false"를 설정해야 합니다.',
            level: 'must'
          },
          {
            id: 'menu-button-m3',
            title: '메뉴에 role="menu"와 menuitem',
            description: '메뉴 컨테이너에 role="menu", 각 항목에 role="menuitem"을 설정해야 합니다.',
            level: 'must'
          },
          {
            id: 'menu-button-m4',
            title: '키보드 탐색 지원',
            description: 'Enter/Space로 메뉴 열기, Arrow 키로 항목 탐색, Escape로 메뉴 닫기를 지원해야 합니다.',
            level: 'must'
          }
        ],
        should: [
          {
            id: 'menu-button-s1',
            title: '메뉴 닫을 때 트리거로 포커스 복귀',
            description: '메뉴를 닫을 때 포커스가 메뉴 버튼으로 돌아오도록 구현하세요.',
            level: 'should'
          },
          {
            id: 'menu-button-s2',
            title: 'Down Arrow로 메뉴 열기',
            description: '버튼에 포커스가 있을 때 Down Arrow 키로 메뉴를 열고 첫 항목에 포커스를 이동하는 것을 권장합니다.',
            level: 'should'
          }
        ],
        avoid: [
          {
            id: 'menu-button-a1',
            title: 'Tab으로 메뉴 항목 탐색',
            description: '메뉴 항목 간 이동에 Tab 키를 사용하지 마세요. Arrow 키로 탐색해야 합니다.',
            level: 'avoid'
          },
          {
            id: 'menu-button-a2',
            title: '메뉴에 role="menu" 없이 구현',
            description: 'role="menu" 없이 ul/li로만 구성하면 스크린리더가 메뉴임을 인식하지 못합니다.',
            level: 'avoid'
          }
        ]
      },
  ...
  return (
    <div>
      ...
      {isOpen && (
        <ul id="action-menu" role="menu" onKeyDown={handleKeyDown}>
          {items.map((item, i) => (
    ...
    designSystems: {
      material: {
        ...
        additionalChecks: [
          {
            id: 'menu-button-mui-1',
            title: 'MenuList와 MenuItem 사용',
            description: 'MUI Menu는 role="menu"와 aria 속성을 자동으로 처리합니다. MenuList/MenuItem을 사용하세요.',
            level: 'should'
          }
        ],
        codeSample: {
          language: 'tsx',
          label: 'MUI Menu Button',
  ...
  return (
    <>
      ...
      <Menu
        ...
        onClose={() => setAnchorEl(null)}
      >
        <MenuItem onClick={() => setAnchorEl(null)}>수정</MenuItem>
        <MenuItem onClick={() => setAnchorEl(null)}>복사</MenuItem>
        <MenuItem onClick={() => setAnchorEl(null)}>삭제</MenuItem>
      </Menu>
    </>
  );
}`
        ...
        notes: [
          'MUI Menu는 키보드 탐색과 포커스 관리를 자동으로 처리합니다.',
          'aria-controls와 aria-expanded를 Button에 직접 추가해 스크린리더에 연결 관계를 알려주세요.',
          'onClose 시 anchorEl을 null로 설정하면 포커스가 트리거 버튼으로 자동 복귀됩니다.'
        ]
      },
      radix: {
        id: 'radix',
  ...
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        notes: [
          'Radix DropdownMenu는 role="menu"와 모든 ARIA 속성, 키보드 탐색을 자동으로 처리합니다.',
          'Trigger에 asChild를 사용하면 커스텀 버튼을 트리거로 사용할 수 있습니다.',
          '포커스 관리(열기/닫기 시 포커스 이동)도 자동으로 처리됩니다.'
        ]
      },
      antd: {
        id: 'antd',
        ...
        codeSample: {
          language: 'tsx',
          label: 'Ant Design Dropdown',
          code: `import Dropdown from 'antd/es/dropdown';
...
function MenuButtonDemo() {
  return (
    <Dropdown menu={{ items }} trigger={['click']}>
      <Button>작업 ▼</Button>
        ...
        notes: [
          'Ant Design Dropdown은 role="menu"와 키보드 탐색을 자동으로 지원합니다.',
          'trigger={["click"]}으로 클릭 시에만 열리도록 설정하세요 (hover 방지).',
          'menu.items에 key를 반드시 제공해야 접근성이 올바르게 동작합니다.'
        ]
      }
    }
  },
  {
    slug: 'toolbar',
    name: 'Toolbar',
    description: '관련 컨트롤을 묶는 툴바 컨테이너 컴포넌트',
    wcagCriteria: ['2.1.1 Keyboard', '4.1.2 Name, Role, Value'],
    tags: ['interactive', 'navigation'],
    baseline: {
      checklist: {
        must: [
          {
            id: 'toolbar-m1',
            title: 'role="toolbar"와 레이블',
            description: '툴바 컨테이너에 role="toolbar"를 설정하고 aria-label 또는 aria-labelledby로 레이블을 제공해야 합니다.',
            level: 'must'
          },
          {
            id: 'toolbar-m2',
            title: 'Arrow 키로 내부 탐색',
            description: '가로 툴바는 Left/Right Arrow로 컨트롤 간 이동해야 합니다. Tab은 툴바 전체를 하나의 탭 정지점으로 처리해야 합니다.',
            level: 'must'
          },
          {
            id: 'toolbar-m3',
            title: 'roving tabindex 구현',
            description: '현재 포커스된 컨트롤만 tabindex="0", 나머지는 tabindex="-1"을 사용해야 합니다.',
            level: 'must'
          }
        ],
        should: [
          {
            id: 'toolbar-s1',
            title: '3개 이상 컨트롤에만 toolbar 사용',
            description: '툴바는 3개 이상의 컨트롤을 그룹화할 때만 사용하세요.',
            level: 'should'
          },
          {
            id: 'toolbar-s2',
            title: '구분선에 role="separator"',
            description: '툴바 내 컨트롤 그룹 사이 시각적 구분선에 role="separator"를 추가하세요.',
            level: 'should'
          }
        ],
        avoid: [
          {
            id: 'toolbar-a1',
            title: '텍스트 입력 필드를 툴바 중간에 배치',
            description: '텍스트 입력 필드는 Arrow 키 충돌로 탐색을 방해합니다. 불가피하다면 툴바의 마지막 요소로 배치하세요.',
            level: 'avoid'
          },
          {
            id: 'toolbar-a2',
            title: '레이블 없이 아이콘만 사용',
            description: '아이콘만 있는 툴바 버튼에는 aria-label로 목적을 설명해야 합니다.',
            level: 'avoid'
          }
        ]
      },
    ...
    designSystems: {
      material: {
        ...
        additionalChecks: [
          {
            id: 'toolbar-mui-1',
            title: 'ToggleButtonGroup에 aria-label',
            description: 'MUI ToggleButtonGroup을 툴바로 사용할 때 aria-label로 그룹 목적을 명시하세요.',
            level: 'must'
          }
        ],
        codeSample: {
          language: 'tsx',
          label: 'MUI ToggleButtonGroup',
  ...
  return (
    ...
    >
      ...
      <ToggleButton value="underline" aria-label="밑줄">
        ...
        notes: [
          'MUI ToggleButtonGroup은 자체적으로 role="group"을 사용합니다. role="toolbar"가 필요하면 별도 div로 감싸세요.',
          '각 ToggleButton에 aria-label을 추가하면 아이콘만 있을 때도 접근 가능합니다.',
          'exclusive prop으로 단일 선택 모드를 활성화할 수 있습니다.'
        ]
      },
      radix: {
        id: 'radix',
        ...
        codeSample: {
          language: 'tsx',
          label: 'Radix UI Toolbar',
          code: `import * as Toolbar from '@radix-ui/react-toolbar';
...
function ToolbarDemo() {
  return (
    <Toolbar.Root aria-label="텍스트 서식">
      ...
      <Toolbar.Separator />
      <Toolbar.Button aria-label="정렬">정렬</Toolbar.Button>
    </Toolbar.Root>
  );
}`
        },
        notes: [
          'Radix Toolbar는 role="toolbar"와 Arrow 키 탐색(roving tabindex)을 자동으로 처리합니다.',
          'Toolbar.Separator에 role="separator"가 자동으로 설정됩니다.',
          'ToggleGroup type="multiple"이면 다중 선택, type="single"이면 단일 선택입니다.'
        ]
      },
      antd: {
        id: 'antd',
        ...
        codeSample: {
          language: 'tsx',
          label: 'Ant Design Space + Button',
          code: `import Space from 'antd/es/space';
import Button from 'antd/es/button';

function ToolbarDemo() {
  const [active, setActive] = useState<string[]>([]);
  const toggle = (val: string) => setActive(a => a.includes(val) ? a.filter(v => v !== val) : [...a, val]);
  return (
    <div role="toolbar" aria-label="텍스트 서식">
      <Space>
        <Button
          type={active.includes('bold') ? 'primary' : 'default'}
          aria-pressed={active.includes('bold')}
          onClick={() => toggle('bold')}
        >
          굵게
        </Button>
        <Button
          type={active.includes('italic') ? 'primary' : 'default'}
          aria-pressed={active.includes('italic')}
        ...
        notes: [
          'Ant Design에는 전용 Toolbar 컴포넌트가 없으므로 div에 role="toolbar"를 직접 추가하세요.',
          'aria-pressed로 토글 버튼 상태를 스크린리더에 전달하세요.',
          'Arrow 키 탐색이 필요하다면 roving tabindex 로직을 직접 구현해야 합니다.'
        ]
      }
    }
  }
