  ...
  return (
    <div className='max-w-7xl mx-auto px-6 sm:px-10 py-10 sm:py-14'>
      <div className='mb-8 sm:mb-10'>
        ...
        <p className='text-mist-700 text-sm leading-relaxed'>{t.home.subtitle}</p>
      </div>
      ...
      <div>
        <div className='lg:hidden mb-5 p-3 bg-white border border-mist-200 rounded-xl'>
          <p className='text-[10px] font-semibold uppercase tracking-wider text-mist-500 mb-2'>{t.home.supportedDS}</p>
        ...
        <h2 className='text-xs font-semibold text-mist-700 uppercase tracking-wider mb-5'>{t.home.allPatterns}</h2>
